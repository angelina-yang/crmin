...
2. If multiple plausible matches, prefer the one whose current title aligns with the provided role
3. If no confident match after up to 3 searches, set linkedin_url to null
